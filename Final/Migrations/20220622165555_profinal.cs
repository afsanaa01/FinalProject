...
{
    public partial class profinal : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Part5 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InnerImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Name5 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Part6 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Part7 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinestPlants", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeasonFinests", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpertTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExpertText = table.Column<string>(type: "nvarchar(max)", nullable: true),
