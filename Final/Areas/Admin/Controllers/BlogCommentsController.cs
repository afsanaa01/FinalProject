...
namespace Final.Areas.Admin.Controllers
{
    ...
    public class BlogCommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Comment,Name,Email,Id")] BlogComment blogComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Comment,Name,Email,Id")] BlogComment blogComment)
        {
