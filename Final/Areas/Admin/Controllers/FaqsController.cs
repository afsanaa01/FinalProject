...
namespace Final.Areas.Admin.Controllers
{
    ...
    public class FaqsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Question,Answer,Type,Id")] Faq faq)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Question,Answer,Type,Id")] Faq faq)
        {
            if (id != faq.Id)
            {
                return NotFound();
